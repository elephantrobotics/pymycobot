...
class Pro630Socket(CloseLoop):
    def __init__(self, ip, netport=9000, debug=False):
        ...
        """
        super(Pro630Socket, self).__init__(debug)
    ...
    def _mesg(self, genre, *args, **kwargs):
        args = (1,)
        read_data = super(Pro630Socket, self)._mesg(genre, *args, **kwargs)
    ...
    def power_on(self):
        print("Power on Client")
        return super().power_on()
    
    def power_off(self):
        print("Power Off Client")
