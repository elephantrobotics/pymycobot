...
from pymycobot.common import ProGripper, MyHandGripper
...
class ThreeHand:
    """L1 MyGripper H100 Three Finger Claw Interface Class"""
    def calibration_parameters(self, *args, **kwargs):
        pass
    ...
    def _send_custom_command(self, arm_id, gripper_id, func_code, reg_addr, *data):
        """
        General Modbus command sending method
    ...
    def _write_custom_check_bytes(self, arm_id, gripper_id, reg_addr, *data):
        """Write custom register with raw byte parameters."""
        self._check_gripper_id(gripper_id, arm_id)
        _, recv = self._send_custom_command(arm_id, gripper_id, 0x06, reg_addr, *data)
    ...
    def _write_custom_check(self, arm_id, gripper_id, reg_addr, *values):
        """Write register and verify response robustly (support calibration delay)"""
        self._check_gripper_id(gripper_id, arm_id)
        data = []
        for value in values:
    ...
    def _read_custom_register(self, arm_id, gripper_id, reg_addr, *values):
        """Reads a register with command verification"""
        self._check_gripper_id(gripper_id, arm_id)
        data = []
        for value in values:
    ...
    def get_hand_firmware_major_version(self, arm_id, gripper_id=14):
        ...
        Args:
            ...
            gripper_id (int): 1 ~ 254, defaults to 14
        """
        val = self._read_custom_register(arm_id, gripper_id, MyHandGripper.GET_HAND_MAJOR_FIRMWARE_VERSION)
        return val / 10.0 if val >= 0 else -1

    def get_hand_firmware_minor_version(self, arm_id, gripper_id=14):
        ...
        Args:
            ...
            gripper_id (int): 1 ~ 254, defaults to 14
        """
        val = self._read_custom_register(arm_id, gripper_id, MyHandGripper.GET_HAND_MINOR_FIRMWARE_VERSION)
        return val if val >= 0 else -1

    def set_hand_gripper_id(self, arm_id, target_id, gripper_id=14):
        """Set the gripper ID
        ...
        """
        self.calibration_parameters(class_name=self.__class__.__name__, target_id=target_id)
        return self._write_custom_check(arm_id, gripper_id, MyHandGripper.SET_HAND_GRIPPER_ID, target_id)

    def get_hand_gripper_id(self, arm_id, gripper_id=14):
        """Get the gripper ID
        ...
        """
        return self._read_custom_register(arm_id, gripper_id, MyHandGripper.GET_HAND_GRIPPER_ID)

    def set_hand_gripper_angle(self, arm_id, joint_id, gripper_angle, gripper_id=14):
        ...
        return self._write_custom_check(arm_id, gripper_id, MyHandGripper.SET_HAND_GRIPPER_ANGLE, joint_id, gripper_angle)

    def get_hand_gripper_angle(self, arm_id, joint_id, gripper_id=14):
        ...
        return self._read_custom_register(arm_id, gripper_id, MyHandGripper.GET_HAND_GRIPPER_ANGLE, joint_id)

    def set_hand_gripper_angles(self, arm_id, gripper_angles, speed, gripper_id=14):
        """Set the angle of the single joint of the gripper
        ...
        return self._write_custom_check(arm_id, gripper_id, MyHandGripper.SET_HAND_GRIPPER_ANGLES, gripper_angles, speed)

    def get_hand_gripper_angles(self, arm_id, gripper_id=14):
        """Set the angle of the single joint of the gripper
        ...
        """
        return self._read_custom_register(arm_id, gripper_id, MyHandGripper.GET_HAND_ALL_ANGLES)

    def set_hand_gripper_torque(self, arm_id, joint_id, torque_value, gripper_id=14):
        ...
        return self._write_custom_check(arm_id, gripper_id, MyHandGripper.SET_HAND_GRIPPER_TORQUE, joint_id, torque_value)

    def get_hand_gripper_torque(self, arm_id, joint_id, gripper_id=14):
        """ Setting gripper torque
        ...
        """
        self.calibration_parameters(class_name=self.__class__.__name__, hand_gripper_joint_id=joint_id)
        return self._read_custom_register(arm_id, gripper_id, MyHandGripper.GET_HAND_GRIPPER_TORQUE, joint_id)

    def set_hand_gripper_calibrate(self, arm_id, joint_id, gripper_id=14):
        ...
        return self._write_custom_check(arm_id, gripper_id, MyHandGripper.SET_HAND_GRIPPER_CALIBRATION, joint_id, 0)

    def get_hand_gripper_status(self, arm_id, gripper_id=14):
        ...
        return self._read_custom_register(arm_id, gripper_id, MyHandGripper.GET_HAND_GRIPPER_STATUS)

    def set_hand_gripper_enabled(self, arm_id, flag, gripper_id=14):
        ...
        return self._write_custom_check(arm_id, gripper_id, MyHandGripper.SET_HAND_GRIPPER_ENABLED, flag)

    def set_hand_gripper_speed(self, arm_id, joint_id, speed, gripper_id=14):
        ...
        return self._write_custom_check(arm_id, gripper_id, MyHandGripper.SET_HAND_GRIPPER_SPEED, joint_id, speed)

    def get_hand_gripper_default_speed(self, arm_id, joint_id, gripper_id=14):
        ...
        """
        self.calibration_parameters(class_name=self.__class__.__name__, hand_gripper_joint_id=joint_id)
        return self._read_custom_register(arm_id, gripper_id, MyHandGripper.GET_HAND_GRIPPER_DEFAULT_SPEED, joint_id)

    def set_hand_gripper_p(self, arm_id, joint_id, value, gripper_id=14):
        ...
        return self._write_custom_check(arm_id, gripper_id, MyHandGripper.SET_HAND_GRIPPER_P, joint_id, value)

    def get_hand_gripper_p(self, arm_id, joint_id, gripper_id=14):
        ...
        """
        self.calibration_parameters(class_name=self.__class__.__name__, hand_gripper_joint_id=joint_id)
        return self._read_custom_register(arm_id, gripper_id, MyHandGripper.GET_HAND_GRIPPER_P, joint_id)

    def set_hand_gripper_d(self, arm_id, joint_id, value, gripper_id=14):
        ...
        return self._write_custom_check(arm_id, gripper_id, MyHandGripper.SET_HAND_GRIPPER_D, joint_id, value)

    def get_hand_gripper_d(self, arm_id, joint_id, gripper_id=14):
        ...
        """
        self.calibration_parameters(class_name=self.__class__.__name__, hand_gripper_joint_id=joint_id)
        return self._read_custom_register(arm_id, gripper_id, MyHandGripper.GET_HAND_GRIPPER_D, joint_id)

    def set_hand_gripper_i(self, arm_id, joint_id, value, gripper_id=14):
        ...
        return self._write_custom_check(arm_id, gripper_id, MyHandGripper.SET_HAND_GRIPPER_I, joint_id, value)

    def get_hand_gripper_i(self, arm_id, joint_id, gripper_id=14):
        ...
        """
        self.calibration_parameters(class_name=self.__class__.__name__, hand_gripper_joint_id=joint_id)
        return self._read_custom_register(arm_id, gripper_id, MyHandGripper.GET_HAND_GRIPPER_I, joint_id)

    def set_hand_gripper_min_pressure(self, arm_id, joint_id, value, gripper_id=14):
        ...
        return self._write_custom_check(arm_id, gripper_id, MyHandGripper.SET_HAND_GRIPPER_MIN_PRESSURE, joint_id, value)

    def get_hand_gripper_min_pressure(self, arm_id, joint_id, gripper_id=14):
        """ Set the minimum starting force of the single joint of the gripper
        ...
        """
        self.calibration_parameters(class_name=self.__class__.__name__, hand_gripper_joint_id=joint_id)
        return self._read_custom_register(arm_id, gripper_id, MyHandGripper.GET_HAND_GRIPPER_MIN_PRESSURE, joint_id)

    def set_hand_gripper_clockwise(self, arm_id, joint_id, value, gripper_id=14):
        ...
        return self._write_custom_check(arm_id, gripper_id, MyHandGripper.SET_HAND_GRIPPER_CLOCKWISE, joint_id, value)

    def get_hand_gripper_clockwise(self, arm_id, joint_id, gripper_id=14):
        ...
        """
        self.calibration_parameters(class_name=self.__class__.__name__, hand_gripper_joint_id=joint_id)
        return self._read_custom_register(arm_id, gripper_id, MyHandGripper.GET_HAND_GRIPPER_CLOCKWISE, joint_id)

    def set_hand_gripper_counterclockwise(self, arm_id, joint_id, value, gripper_id=14):
        ...
        """
        self.calibration_parameters(class_name=self.__class__.__name__, gripper_id=gripper_id, hand_gripper_joint_id=joint_id, clockwise=value)
        return self._write_custom_check(arm_id, gripper_id, MyHandGripper.SET_HAND_GRIPPER_COUNTERCLOCKWISE, joint_id, value)

    def get_hand_gripper_counterclockwise(self, arm_id, joint_id, gripper_id=14):
        ...
        """
        self.calibration_parameters(class_name=self.__class__.__name__, hand_gripper_joint_id=joint_id)
        return self._read_custom_register(arm_id, gripper_id, MyHandGripper.GET_HAND_GRIPPER_COUNTERCLOCKWISE, joint_id)

    def set_hand_gripper_pinch_action(self, arm_id, pinch_pose, rank_mode, idle_flag=False, gripper_id=14):
        ...
        """
        if not idle_flag:
            self.calibration_parameters(class_name=self.__class__.__name__, hand_pinch_pose=pinch_pose, hand_rank_mode=rank_mode)
            return self._write_custom_check_bytes(arm_id, gripper_id, MyHandGripper.SET_HAND_GRIPPER_PINCH_ACTION_SPEED_CONSORT, pinch_pose, rank_mode)

        else:
            self.calibration_parameters(class_name=self.__class__.__name__, hand_pinch_pose=pinch_pose, hand_rank_mode=rank_mode, hand_idle_flag=idle_flag)
            return self._write_custom_check_bytes(arm_id, gripper_id, MyHandGripper.SET_HAND_GRIPPER_PINCH_ACTION_SPEED_CONSORT, pinch_pose, rank_mode, idle_flag)

    def get_hand_gripper_model(self, arm_id, gripper_id=14):
        ...
        Args:
            ...
            gripper_id (int): 1 ~ 254, defaults to 14
        """
        return self._read_custom_register(arm_id, gripper_id, MyHandGripper.GET_HAND_GRIPPER_ROBOT_MODEL)
...
class L1EndControl(L1ForceGripper, ThreeHand, FiveFingerGripper):
    pass