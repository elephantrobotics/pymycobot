...
def _interpret_status_code(language, status_code):
    ...
    status_messages = {
        ...
        "en_US": {
            ...
            8: "Prompt: Sport mode setting ended.",
            9: "Prompt: Emergency stop has been pressed.",
...
class RobotLimit:
    robot_limit = {
        ...
        "MercuryE1": {
            ...
            "radius_min": [-2.71, -0.96, -2.79, -2.36, -2.79, -1.75, -2.36],
            "radius_max": [2.705, 1.83, 2.79, 0.31, 2.79, 2.04, 2.36],
