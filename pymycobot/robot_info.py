...
def _interpret_status_code(language, status_code):
    ...
    status_messages = {
        ...
        "en_US": {
            ...
            257: "Error: Joint 1 motor encoder reported an error.",
            258: "Error: Joint 2 motor encoder reported an error.",
            259: "Error: Joint 3 motor encoder reported an error.",
            260: "Error: Joint 4 motor encoder reported an error.",
            261: "Error: Joint 5 motor encoder reported an error.",
            262: "Error: Joint 6 motor encoder reported an error.",
            263: "Error: Joint 7 motor encoder reported an error.",
            289: "Error: Joint 1 motor position is out of tolerance. ",
            290: "Error: Joint 2 motor position is out of tolerance. ",
            291: "Error: Joint 3 motor position is out of tolerance. ",
            292: "Error: Joint 4 motor position is out of tolerance. ",
            293: "Error: Joint 5 motor position is out of tolerance. ",
            294: "Error: Joint 6 motor position is out of tolerance. ",
            295: "Error: Joint 7 motor position is out of tolerance. ",
