...
class RobotStatusL1Info(object):
    ...
    @staticmethod
    def _L1_interpret_status_code(language, status_code):
        # 将状态码映射到易懂的提示信息
        status_messages = {
            "zh_CN": {
                0: "",
            ...
            "en_US": {
                0: "",
                1: "Error: Joint 1 exceeds the limit.",
                2: "Error: Joint 2 exceeds the limit.",
                3: "Error: Joint 3 exceeds the limit.",
                4: "Error: Joint 4 exceeds the limit.",
                5: "Error: Joint 5 exceeds the limit.",
                6: "Error: Joint 6 exceeds the limit.",
                7: "Error: Joint 7 exceeds the limit.",
                ...
                12: "Prompt: Machine is powered off.",
                16: "Tip: Collision protection.",
                17: "Tip: Collision protection.",
                18: "Tip: Collision protection.",
                19: "Tip: Collision protection.",
                ...
                209: "Error: Joint 1 zero position not calibrated.",
                210: "Error: Joint 2 zero position not calibrated.",
                211: "Error: Joint 3 zero position not calibrated.",
                212: "Error: Joint 4 zero position not calibrated.",
                213: "Error: Joint 5 zero position not calibrated.",
                214: "Error: Joint 6 zero position not calibrated.",
                215: "Error: Joint 7 zero position not calibrated.",
                216: "Error: Joint 8 zero position not calibrated.",
                217: "Error: Joint 9 zero position not calibrated.",
...
class RobotLimit:
    robot_limit = {
        ...
        "MercuryL1Client": {
            ...
            "coord_id": [1, 2, 3, 4, 5, 6],
            "angles_min": [-181, -46, -155, -135, -155, -115, -137],
            "angles_max": [135, 96, 155, 18, 155, 115, 137],
            "left_angles_min": [-181, -46, -155, -135, -155, -115, -137, 0],
            "left_angles_max": [135, 96, 155, 18, 155, 115, 137, 40],
            "right_angles_min": [-181, -46, -155, -135, -155, -115, -137, -50, -82],
            "right_angles_max": [135, 96, 155, 18, 155, 115, 137, 50, 82],
            "coords_min": [-623, -829, -227, -180, -180, -180],
            "coords_max": [623, 829, 957, 180, 180, 180],
            "radius_min": [-3.16, -0.80, -2.71, -2.36, -2.71, -2.01, -2.39],
            "radius_max": [ 2.36,  1.68,  2.71,  0.31,  2.71,  2.01,  2.39],
