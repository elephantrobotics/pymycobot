...
class RobotLimit:
    robot_limit = {
        ...
        "MercuryL1Client": {
            "joint_id": [1, 2, 3, 4, 5, 6, 7],
            "all_joint_id": [1, 2, 3, 4, 5, 6, 7, 8, 9],
            "left_joint_id": [1, 2, 3, 4, 5, 6, 7, 8],
            "right_joint_id": [1, 2, 3, 4, 5, 6, 7, 8, 9],
            "left_servo_id": [1, 2, 3, 4, 5, 6, 7, 8],
            "right_servo_id": [1, 2, 3, 4, 5, 6, 7, 8, 9],
            "coord_id": [1, 2, 3, 4, 5, 6],
            "angles_min": [-181, -46, -155, -135, -155, -115, -155],
            "angles_max": [135, 96, 155, 18, 155, 115, 155],
            "left_angles_min": [-181, -46, -155, -135, -155, -115, -155, 0],
            "left_angles_max": [135, 96, 155, 18, 155, 115, 155, 40],
            "right_angles_min": [-181, -46, -155, -135, -155, -115, -155, -50, -82],
            "right_angles_max": [135, 96, 155, 18, 155, 115, 155, 50, 82],
            "coords_min": [-1000, -1000, -1000, -180, -180, -180],
            "coords_max": [1000, 1000, 1000, 180, 180, 180],
