...
class L1CloseLoop(DataProcessor):
    ...
    def __init__(self, debug=False):
        super(L1CloseLoop, self).__init__(debug)
    ...
    def stop(self, arm_id, _async=False):
        """Robot stops moving
        ...
        self.calibration_parameters(
            class_name=self.__class__.__name__, arm_id=arm_id)
        return self._mesg(ProtocolCode.STOP, arm_id,  _async=_async)

    def pause(self, arm_id):
    ...
    def resume(self, arm_id):
        ...
        return self._mesg(ProtocolCode.RESUME, arm_id)

    def set_servo_calibration(self, arm_id, joint_id):
    ...
    def set_end_type(self, arm_id, end):
        ...
        """
        self.calibration_parameters(
            class_name=self.__class__.__name__, arm_id=arm_id, end=end)
        return self._mesg(ProtocolCode.SET_END_TYPE, arm_id, end)
